...
/**
 * Integration test for the minimal ScoutnetClient.
 * Requires valid Scoutnet credentials as environment variables:
 * - SCOUTNET_USERNAME
 * - SCOUTNET_PASSWORD
 */
public class ScoutnetClientIT {
    ...
    @Test
    void testAuthenticationAndProfileFetch() {
        ...
        assertEquals(authResponse.getMember().getMemberNo(), profile.getMemberNo(),
            "Member number in profile should match member number in auth response");
